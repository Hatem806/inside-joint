...
export class ProductsComponent implements OnInit {
  ...
  pageImageSrc2 =
    '../../../assets/products-photo/xfidia-slide4.jpg.pagespeed.ic.x0C8HaECKd-1.png';
  ...
  goToVideoLink(product) {
    window.location.href =
      this.apiService.getAssetsService().getVideosUrl() + product.videoPath;
  }
  goToPdfLink(documentPath) {
    window.location.href =
      this.apiService.getAssetsService().getDocumentsUrl() + documentPath;
  }
  onRightArrow() {
    //row of 4
